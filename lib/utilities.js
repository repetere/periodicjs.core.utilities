...
Utilities.prototype.getAdminMenu = function (options) {
	...
	for (var x in appSettings.extconf.extensions) {
		if (appSettings.extconf.extensions[x].enabled === true && appSettings.extconf.extensions[x].periodicConfig['periodicjs.ext.asyncadmin']) {
			var extmenudata = appSettings.extconf.extensions[x].periodicConfig['periodicjs.ext.asyncadmin'];
